...
class TestOstoskori(unittest.TestCase):
    ...
    def test_yhden_tuotteen_lisaamisen_jlkn_ostoskori_sis_ostoksen_jolla_sama_nimi_kuin_tuotteella_ja_lkm_yksi(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jlkn_ostoskori_sis_ostoksen_jolla_sama_nimi_kuin_tuotteella_ja_lkm_2(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)        
        self.kori.lisaa_tuote(maito)
        ostos = self.kori.ostokset()[0]
    ...
    def test_jos_korissa_kaksi_samaa_tuotetta_ja_toinen_poistetaan_jaa_koriin_ostos_jossa_yksi_kpl_tuotetta(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
